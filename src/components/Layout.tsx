      ...
      <footer className="py-8 border-t border-purple-50 bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.02)] mt-auto">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-sm text-gray-500 font-medium">
             Jika ada kendala <a href="https://wa.me/6285256510571" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-700 font-bold underline">klik disini</a>
          </p>
        </div>
      </footer>
